...
#[derive(Debug)]
pub struct SpiritGuideProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SpiritGuideProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SpiritGuide processing");
    
    let mut processor = SpiritGuideProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SpiritGuideProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SpiritGuideProcessor::new(false);
